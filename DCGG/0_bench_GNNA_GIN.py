...
if islocal:
    dataset = [
        ('ogbn-proteins'		, 100      , 47  , True, 14),
    ]

outfile = './log/0_bench_DCGG_GIN_' + str(time.time())+".log"
...
max_warp_size = 1024
dim_slice_size = [32]#[4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64]
#print(dim_slice_size)
warp_size_k_li = [12]
#warp_size_k_li = [18]
